		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#applicationtoyota-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"applicationtoyota-display": {
								"semanticObject": "applicationtoyota",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=application.toyota",
									"url": sap.ui.require.toUrl("application/toyota")
								}
							}
						}
					}
