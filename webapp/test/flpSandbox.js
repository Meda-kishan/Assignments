		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#remoteserviceodata-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"remoteserviceodata-display": {
								"semanticObject": "remoteserviceodata",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=remoteservice.odata",
									"url": sap.ui.require.toUrl("remoteservice/odata")
								}
							}
						}
					}
